...
class AdminCommentCard extends StatefulWidget {
  ...
  @override
  State<AdminCommentCard> createState() => _AdminCommentCardState();
}

class _AdminCommentCardState extends State<AdminCommentCard> {
