...
class ActiveWorkoutScreen extends StatefulWidget {
  final snap;
  const ActiveWorkoutScreen({super.key, this.snap});
...
class _ActiveWorkoutScreenState extends State<ActiveWorkoutScreen> {
  ...
  getData() async {
    isLoading = true;
    try {
      var exerciseSnap = await FirebaseFirestore.instance
          .collection('users')
      ...
      for (var exerciseDoc in exerciseSnap.docs) {
  ...
  void initState() {
    ...
    workoutID = widget.snap['workoutID'];
    workoutName = widget.snap['workoutName'];
    workoutNote = widget.snap['workoutNote'];
    workoutNotesController.text = workoutNote;
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                deleteAllExercises();
                updateWorkoutInFirestore(exercises);
  ...
  // =========================================================================================================================
  // Updating Workout and Exercise into firebase
  // =========================================================================================================================
  ...
  void updateWorkoutInFirestore(List<Exercise> exercises) async {
    final firestore = FirebaseFirestore.instance;
    ...
    //Run this to delete all exercises, so new data can be added
    print(exercises);
